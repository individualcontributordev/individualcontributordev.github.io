...
- Highwind copy: a full playthrough compressed to ~2-3 hours — its own separate base/mod, not a bigger CSR+ (story mechanics, option choices, complete dialogue removal cut; doesn't stack with CSR+ scene add-ons).
